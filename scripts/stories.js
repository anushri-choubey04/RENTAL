fetch('components/story.html')
  .then(response => response.text())
  .then(data => {
    document.getElementById('story-container').innerHTML = data;
    ...
    const stories = [
      {
        ...
        image: null,
        formUrl: "https://docs.google.com/forms/d/e/your-form-id/viewform",
      },
      {
        id: 2,
        username: "Wedding Collection",
        profilePic: "https://images.unsplash.com/photo-1590874103328-eac38a683ce7?ixlib=rb-1.2.1&auto=format&fit=crop&w=1000&q=80",
        media: [
          {
            type: "image",
      ...
      },
      {
        id: 3,
        username: "Men's Wear",
        profilePic: "https://images.unsplash.com/photo-1593030761757-71fae45fa0e7?w=150&h=150&fit=crop",
        media: [
          {
            type: "image",
